 ...
 */
final class Version20220901224010 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE "group" (id INT NOT NULL, company_id_id INT NOT NULL, updated_by_id INT NOT NULL, group_name VARCHAR(255) NOT NULL, group_status VARCHAR(255) NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_6DC044C538B53C32 ON "group" (company_id_id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_6DC044C5896DBBDE ON "group" (updated_by_id)');
        $this->addSql('COMMENT ON COLUMN "group".updated_at IS \'(DC2Type:datetime_immutable)\'');
        $this->addSql('CREATE TABLE message (id INT NOT NULL, group_id_id INT NOT NULL, user_id_id INT NOT NULL, updated_by_id INT NOT NULL, message_status VARCHAR(255) NOT NULL, message TEXT NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_B6BD307F2F68B530 ON message (group_id_id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_B6BD307F9D86650F ON message (user_id_id)');
        ...
        $this->addSql('CREATE TABLE user_group (id INT NOT NULL, user_id_id INT NOT NULL, group_id_id INT NOT NULL, notifications INT NOT NULL, PRIMARY KEY(id))');
