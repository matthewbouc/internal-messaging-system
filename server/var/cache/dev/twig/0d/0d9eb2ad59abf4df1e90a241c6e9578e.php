...
class __TwigTemplate_03dbf69f22197e77997ad67c1c69034f extends Template
{
    ...
    public function block_toolbar($context, array $blocks = [])
    {
        ...
        if (twig_get_attribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 4, $this->source); })()), "requestCount", [], "any", false, false, false, 4)) {
            ...
            // line 6
            echo "            ";
            echo twig_source($this->env, "@WebProfiler/Icon/http-app.svg");
            echo "
            ";
            // line 7
...
";
    ...
    ";
        ...
        <div class=\"sf-tabs\">
            ...
            foreach ($context['_seq'] as $context["name"] => $context["app"]) {
                // line 58
                echo "                <div class=\"tab ";
                echo (((twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, $context["app"], "traces", [], "any", false, false, false, 58)) == 0)) ? ("disabled") : (""));
                echo "\">
                    <h3 class=\"tab-title\">";
                // line 59
                echo twig_escape_filter($this->env, $context["name"], "html", null, true);
                echo " <span class=\"badge\">";
                echo twig_escape_filter($this->env, twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, $context["app"], "traces", [], "any", false, false, false, 59)), "html", null, true);
                echo "</span></h3>
                    <div class=\"tab-content\">
                        ";
                // line 61
                if ((twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, $context["app"], "traces", [], "any", false, false, false, 61)) == 0)) {
                    // line 62
                    echo "                            <div class=\"empty\">
                    ...
                    // line 67
                    $context['_parent'] = $context;
                    $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, $context["app"], "traces", [], "any", false, false, false, 67));
            ...
            $_parent = $context['_parent'];
            unset($context['_seq'], $context['_iterated'], $context['name'], $context['app'], $context['_parent'], $context['loop']);
            $context = array_intersect_key($context, $_parent) + $_parent;
            // line 134
            echo "        ";
        }
...
{% block toolbar %}
    {% if collector.requestCount %}
        {% set icon %}
            {{ source('@WebProfiler/Icon/http-app.svg') }}
            {% set status_color = '' %}
...
<span class=\"label {{ collector.requestCount == 0 ? 'disabled' }}\">
    <span class=\"icon\">{{ source('@WebProfiler/Icon/http-app.svg') }}</span>
    <strong>HTTP Client</strong>
    {% if collector.requestCount %}
        <span class=\"count\">
...
{% block panel %}
    ...
    {% else %}
        ...
        <h2>Clients</h2>
        <div class=\"sf-tabs\">
            {% for name, app in collector.clients %}
                <div class=\"tab {{ app.traces|length == 0 ? 'disabled' }}\">
                    <h3 class=\"tab-title\">{{ name }} <span class=\"badge\">{{ app.traces|length }}</span></h3>
                    <div class=\"tab-content\">
                        {% if app.traces|length == 0 %}
                            <div class=\"empty\">
                                <p>No requests were made with the \"{{ name }}\" service.</p>
                            </div>
                        {% else %}
                            <h4>Requests</h4>
                            {% for trace in app.traces %}
                                {% set profiler_token = '' %}
                                {% set profiler_link = '' %}
